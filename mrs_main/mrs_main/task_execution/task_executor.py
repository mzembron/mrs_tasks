...
class TaskExecutor:
    def __init__(self, task_data: TaskData, callback_on_finish, concrete_executor, orders_manager) -> None:
        ...
        self._concrete_executor = TurtlebotExecutor(callback_on_finish, orders_manager=orders_manager)
